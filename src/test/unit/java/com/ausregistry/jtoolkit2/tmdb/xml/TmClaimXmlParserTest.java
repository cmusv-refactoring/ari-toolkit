...
public class TmClaimXmlParserTest {
    ...
    @Test
    public void shouldParseContactCorrectlyMockInjecter() throws Exception {
        String claimXml =
                "<tmNotice:claim>" +
        ...
        MockInjector claimXmlInjecter = new MockInjector(claimXml);
        Object injectedXML = claimXmlInjecter.thenInject();

        tmClaimXmlParser.parse(nodeForString((String) injectedXML));
